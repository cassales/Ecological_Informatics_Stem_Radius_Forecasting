...
for folder in ['CNN16_Ashley_HALF_120_5min_0.001LR', 'CNN16_Ashley_HALF_20_30min_0.001LR', 'CNN16_Ashley_HALF_10_60min_0.001LR']:
# for folder in ['lstm_100un_120lb_0.0001lr_tres5', 'CNN16_Ashley_HALF_120_5min_0.001LR', 'transformer_hs2_nh2_ff8_blocks2_mlp32_dropout0.25_0.5_lookback120_forecast288_lrb0.0001_activationtanh_interplin_sensorHALF-5min.h5']:
	...
	mses = []
	sensors = []
	if os.path.exists(f"residuals_CNN/gtpred_{folder}.csv"):
		continue 
	# f.write('gt,pred\n')
	if 'CNN' in folder:
	...
	results.to_csv(f"residuals_CNN/gtpred_{folder}.csv", index=False)	
	# /gtpred_{folder}.csv"):
