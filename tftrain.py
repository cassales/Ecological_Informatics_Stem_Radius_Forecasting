...
#
## %%
#history = model.fit(x=X, y=Y, batch_size=256, epochs=50, validation_split=0.3)
#
## %%
...
#model2.summary()
#
#history = model2.fit(x=X, y=Y, batch_size=1024, epochs=50, validation_split=0.3)
#
...
history = model4.fit(x=X, y=Y, batch_size=512, epochs=50, validation_split=0.3)
